...
function useActiveSection() {
  ...
  useEffect(() => {
    ...
    const sectionIds = ["a-propos", "pasteur", "ministeres", "contact"];
    ...
    <footer className="footer">
      <div className="footer-main">
        <div className="footer-brand-group">
          ...
          <p>
            Nous existons pour glorifier Dieu, édifier les saints et impacter
            notre génération par l’Évangile.
          </p>
        </div>
        ...
        <div className="footer-group footer-contact-group">
          ...
          <span>Mora extrême-nord</span>
          <span>694880056</span>
          <span>narcisse.arenthes@yahoo.fr</span>
      ...
      <div className="footer-bottom">
        <span>© 2026 {name}. Gospel Break Chain Ministry. Tous droits réservés.</span>
      </div>
    </footer>
  );
}
