...
function EmptyPaymentCard() {
  return <div className="payment-placeholder"><div className="placeholder-icon">▣</div><div><span className="dashboard-label">DONS & OFFRANDES</span><h3>Module de paiement</h3><p>Le module de paiement sera connecté séparément. Aucun montant n’est simulé ici.</p></div><span className="coming-soon">À VENIR</span></div>;
}
  ...
  return <>
    ...
    <section className="dashboard-grid dashboard-top-grid">
      <div className="dashboard-panel priority-panel">
        <div className="panel-head"><div><span className="dashboard-label">ACTION IMMÉDIATE</span><h2>À traiter en priorité</h2></div><Link to="/admin/prayer-requests">Voir tout →</Link></div>
      ...
      <div className="dashboard-panel request-overview">
        ...
        <Link className="panel-action" to="/admin/prayer-requests">Consulter les demandes →</Link>
      </div>
      <EmptyPaymentCard />
    </section>
