    ...
    <>
      ...
      <aside className={`admin-sidebar ${open ? "is-open" : ""}`}>
        <Link to="/" className="admin-brand" onClick={onClose}>
          ...
          <span>
            <strong>GOSPEL BREAK</strong>
            <small>CHAIN MINISTRY</small>
          </span>
        </Link>
        ...
        <div className="sidebar-verse" key={verse.id}>
          <span>“</span>
          <p>{verse.text}</p>
          <strong>{verse.reference}</strong>
        </div>
        <small className="sidebar-footer">
          © 2026 Gospel Break Chain Ministry
        </small>
      </aside>
    </>
  );
