...
function whatsappLink(type, form) {
  ...
  if (type === 'prayer') {
    lines.push(`E-mail : ${form.email || 'Non renseigné'}`, `Sujet : ${form.subject || 'Non renseigné'}`, `Urgent : ${form.is_urgent ? 'Oui' : 'Non'}`, `Confidentiel : ${form.is_confidential ? 'Oui' : 'Non'}`);
  }
  lines.push('', '*Message :*', form.message || 'Non renseigné');
